...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   '<=' : 왼쪽의 피연산자가 오른쪽의 피연산자 작거나 같으면 true 아니면 false 를 반환
        * */
        ...
        boolean bool1 = true;
        boolean bool2 = false;
        /* 필기. 논리값은 ==와 != 비교가 가능하지만, 대소비교는 불가능하다. */
...
//        System.out.println("bool1이 bool2 보다 작거나 같은지 비교 : " + (bool1 <= bool2));
        ...
        System.out.println("======================================");
//        System.out.println("str1이 str2 보다 큰지 비교 : " + (str1 > str2));
//        System.out.println("str1이 str2 보다 큰거나 같은지 비교 : " + (str1 >= str2));
//        System.out.println("str1이 str2 보다 작은지 비교 : " + (str1 <= str2));
//        System.out.println("str1이 str2 보다 작거나 같은지 비교 : " + (str1 <= str2));
